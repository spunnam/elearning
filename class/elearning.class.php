	...
	public function getClassesForStudent()
	{
		try {
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<tr><td>" . $code . "</td><td>" . $subj . "</td><td>" . $first_name . " " . $last_name . "</td><td>" . $sy . "</td><td><a href='classes.php?id=" . $id . "&action=enrollStudentToClass' onclick=\"return confirm('Are you sure you want to enroll?');\">ENROLL</a>";
