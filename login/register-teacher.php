	...
	<div style="padding-top:5%">
		<div class="register-container">
			...
			<div class="register-header">
				...
				<span class="register-header-subtitle">Teacher Registration</span>
			</div>
			<!-- REGISTER CONTENT -->
			<div class="register-content">
				...
				<form method="post" id="register-faculty" class="register-form">
					<div class="register-form-group">
						...
						<input type="text" name="userid" class="form-input" id="userid" placeholder="FacultyID..."
							required>
					</div>
					<div class="register-form-group">
			...
			<script
				type="text/javascript">document.getElementById('register-faculty').addEventListener('submit', setRegisterTeacher);</script>
</body>
